...
def render_terms(shell) -> str:
    B = ['<h1>Terms</h1>',
         ...
         '<h2>Third parties</h2>',
         '<p>This site carries third-party display advertising and links to external sites, '
         'including manufacturer and regulator pages. We do not control that content and are not '
